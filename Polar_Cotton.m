...
directory_images='C:\Users\jaray\Desktop\incoh_lat_shear_DH\POLARIZATION\mfiles_polar\final_2026_07_16\data'; % folder with camera records
    ...
    % interference pattern with cotton fibre
    I=apodization_for_propag((fitsread([directory_images '\2025-08-18-0855_7-CapObj_0000.FIT'])));

    % interference pattern without sample
    Iref=apodization_for_propag((fitsread([directory_images '\2025-08-18-0856_2-CapObj_0000.FIT'])));
